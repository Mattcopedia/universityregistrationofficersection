...
const FilterFeature = () => {
  ...
  return (
    ...
    <div  className='pt-2 lg:bg-gray-100 lg:pl-3 '>
      <input  style={{height: "44px"}} ref={focusDiv} className='enterId' placeholder='Student ID'  type="text" id="StudentId"/>  
      </div>  

        <div className="filter lg:bg-gray-100 pl-2 py-2">
   <select>
    <option selected>Statistics Dept </option> 
    <option>Statistics Dept</option>
    <option>Statistics Dept</option>
    <option>Statistics Dept</option> 
    <option>Statistics Dept</option>
  </select> 
