  ...
  const [shouldshow, setShouldshow] = useState(false);
    ...
    return  ( 
      ...
      <FlexColumns>
        ...
        <Paragraphs>
           New student department <br className="responsivemodal"></br>has been created successfully{" "}
        </Paragraphs>
       ...
       <FlexColumnRoot>
       <Paragraph> Create New <br className="responsivemodal"></br>Department</Paragraph> 
     </FlexColumnRoot>
     ...
     <EditProfileRoot>Enter new department information</EditProfileRoot>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>                       
                <FlexColumn1>
                 ...
                 <Text4 htmlFor="OldPassword"> Choose Faculty</Text4>        
                ...
                <select>
                 ...
                 <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                    ...
                    <Text4 htmlFor="newdepartment"> New Department Name</Text4>   
                    <div className='pl-0.5'>     
                    <input  style={{height: "44px"}} ref={focusDiv} className='form' placeholder='Agric Engineering'  type="text" id="newdepartment"/>  
                    </div>  
                    ...
                    <button className='purplebtn' onClick={() => setShouldshow(true)} >Create Department</button> 
                    </div>
