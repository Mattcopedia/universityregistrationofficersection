...
const ImportNewStudent = () => {
  const [shouldshow, setShouldshow] = useState(false);
    ...
    return  ( 
      ...
      <FlexColumns>
        ...
        <Paragraphs>
           New Student Registration <br className="responsivemodal"></br>is successfully{" "}
        </Paragraphs>
       ...
       <FlexColumnRoot>
       <Paragraph> Import New <br className="responsivemodal"></br>Student</Paragraph> 
     </FlexColumnRoot>
  ...
  <div className='ml-5 mb-5'>
    <Name>
        Kindly follow the recommended CSV format strictly
        <br />
        SURNAME, MIDDLENAME, FIRSTNAME, LEVEL,<br className="responsivemodal"></br> MATRICNO, UTMENUMBER, YEAR OF
        ADMISSION,<br className="responsivemodal"></br> GENDER, DOB, STATE OF ORIGIN, PHONENUMBERS
      </Name>
    
 
    <NB>
      NB: Please avoid putting header on the CSV file
    </NB>
    </div>

     <EditProfileRoot>Upload Student Registration</EditProfileRoot>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>                       
                <FlexColumn1>
                 ...
                 <Text4 htmlFor="OldPassword"> Select Student CSV File</Text4>        
                ...
                <select>
                 ...
                 <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                 <Text4 htmlFor="OldPassword"> Upload new student data</Text4> 
                 ...
                 <input className='file' id="uploadCSV" type="file"/>
                    ...
                    <button className='purplebtn' onClick={() => setShouldshow(true)} >Upload data</button> 
                    </div>
...
export default ImportNewStudent; 
