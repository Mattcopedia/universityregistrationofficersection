...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
          Course has<br className="responsivemodal"></br> been assigned successfully{" "}
        </Paragraphw>
       ...
       <FlexColumnRoot>
      <Paragraph> Course<br className="responsivemodal"></br> Allocation</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/xTxRFyAPhZghcQxYcd7c.svg`}  /> 
       </div>  
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
             ...
             <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                    ...
                    <Text4 htmlFor="course"> Select Course</Text4>   
                    ...
                    <Text4 htmlFor="programme"> Select Lecturer</Text4>   

                    <div className="amendment  pr-12 md:pr-0 lg:pr-0 ">
                    <select>
                    <option selected>Dr Alese </option> 
                    <option>Dr Alese </option>
                    ...
                    <button className='purplebtn' >Assign Course</button> 
                    </div>
                </FlexColumn1>
