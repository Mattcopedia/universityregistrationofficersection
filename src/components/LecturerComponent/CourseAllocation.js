...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
          Course has been<br className="responsivemodal"></br> assigned successfully{" "}
        </Paragraphw>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
                ...
                <FlexColumn1>               
                 ...
                 <div className="amendment mr-9 pr-4 md:pr-2 ">
                <select>
                 ...
                 <Text4 htmlFor="course"> Select Lecturer</Text4>        
                 <div className="amendment mr-9 pr-4 md:pr-2 ">
                <select>
                    <option selected>Dr. Alex </option> 
