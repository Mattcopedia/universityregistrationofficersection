...
import LecturerActivate from './LecturerActivate'
import styled from "styled-components"; 
import { Link } from "react-router-dom";

const LecturerActivateProfile = () => {
  ...
  return (
    ...
    { shouldshow && (
      ...
      <FlexColumn>
        ...
        <Paragraph>
          Are you sure you want to <br className="responsivemodal"></br>Deactivate this lecturer{" "}
        </Paragraph>
    ...
    { submit && (
      ...
      <FlexColumn>
        ...
        <Paragraph>
        Lecturer deactivation <br className="responsivemodal"></br>has been updated
          successfully{" "}
        </Paragraph>
  ...
  <WhiteFlexColumnRootyw>
      ...
      <button className="editprofile flex gap-2"><Image1 src={`https://file.rendit.io/n/6tJaKDKNddgX2gLIXwDK.svg`} /> Deactivate</button> 
      </Link>
  ...
  <WhiteFlexRowRootzw>
      <FlexColumnzw>
        ...
        <FlexColumn1zw margin={`0px 0px 0px 1px`}>
          ...
          <Text2zw alignSelf={`flex-start`}>Lecturer 1</Text2zw>
        </FlexColumn1zw> 

        <FlexColumn1zw margin={`0px 0px 0px 1px`}>
          <Text1zw margin={`0`}>Course Assigned</Text1zw>
          <Text2zw alignSelf={`flex-start`}>CSC 300,STA 309,CSC 400</Text2zw>
        </FlexColumn1zw> 
...
export default LecturerActivateProfile