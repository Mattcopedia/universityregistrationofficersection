...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
        Student Status<br className="responsivemodal"></br> has been updated successfully{" "}
        </Paragraphw>
        ...
        <div className="container ">
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
                ...
                <select>
                    <option selected>Safe </option> 
                    <option>Suspension </option>
                    <option>Voluntary withdrawal </option>
                    <option>Temporary withdrawal </option>
                    ...
                    <button className='purplebtn' >Submit</button> 
                    </div>
                </FlexColumn1>
