  ...
  const [shouldshow, setShouldshow] = useState(false);
    ...
    return  ( 
      ...
      <FlexColumns>
        ...
        <Paragraphs>
          Student Registration <br className="responsivemodal"></br>has been updated successfully{" "}
        </Paragraphs>
            ...
            <FlexColumn>                       
                ...
                <select>
                 ...
                 <input className='file' id="uploadCSV" type="file"/>
                    ...
                    <button className='purplebtn' onClick={() => setShouldshow(true)} >Upload registration</button> 
                    </div>
