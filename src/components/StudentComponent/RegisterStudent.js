...
{ shouldshow && (
      ...
      <FlexColumnw>
       ...
       <FlexColumnRoot>
      <Paragraph> Late <br className="responsivemodal"></br> Registration</Paragraph> 
     </FlexColumnRoot>
       ...
       <ImageRoot src={`https://file.rendit.io/n/H5cBdyWtycaRxkh4P5g9.png`}  /> 
        ...
        <EditProfileRoot>Allow Late Registration</EditProfileRoot>
        </div>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
                ...
                <FlexColumn1>               
                 ...
                 <Text4 htmlFor="OldPassword"> Enter Student Id</Text4>   
                 <div className='pr-11'>     
                 <input  style={{height: "44px"}} ref={focusDiv} className='form' placeholder='Stat/11/2009'  type="text" id="StudentId"/>  
                    ...
                    <button className='purplebtn' >Allow</button> 
                    </div>
                </FlexColumn1>
