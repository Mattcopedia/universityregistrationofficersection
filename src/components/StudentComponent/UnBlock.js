...
const UnBlock = () => {
  ...
  return (
    ...
    <div>
       ...
       <FlexColumnRoot>
      <Paragraph> Block/<br className="responsivemodal"></br>Unblocking Student</Paragraph> 
     </FlexColumnRoot> 
        
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/D6nQA6Y02YoUaSuE3xwe.png`} /> 
       </div>  
    ...
    <div  className='pt-2 pl-1 bg-gray-100 lg:bg-gray-100 lg:pl-2 '>
