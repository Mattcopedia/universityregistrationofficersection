...
const UnblockProfile = () => {
  ...
  return (
    ...
    { shouldshow && (
      ...
      <FlexColumn>
        ...
        <Paragraph>
          Are you sure you want to <br className="responsivemodal"></br>Block this student{" "}
        </Paragraph>
  ...
  <WhiteFlexColumnRootyw>
      ...
      <button className="editprofile"> <Image1 src={`https://file.rendit.io/n/zZEsfijFajlS1JDIlXwn.svg`} /> Block</button> 
      </Link>
