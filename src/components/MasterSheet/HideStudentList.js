...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
          Student List<br className="responsivemodal"></br> has been hidden successfully{" "}
        </Paragraphw>
       ...
       <FlexColumnRoot>
      <Paragraph> Hide Student<br className="responsivemodal"></br> List</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/gaheH8LjieezniULacr7.svg`} /> 
       </div>  
     
    </div> 

        <div className='mx-auto my-5'>
        <EditProfileRoot>Enter Student Information</EditProfileRoot>
        </div>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
                ...
                <FlexColumn1>   
                 ...
                 <Text4 htmlFor="Enter Student Id"> Student Id</Text4>   
                 <div className='pr-10 md:pr-12 lg:pr-0'>     
                 <input  style={{height: "44px"}} ref={focusDiv} className='form' placeholder='CSC/11/2009'  type="text" id="StudentId"/>  
              </div>  
             ...
             <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                    ...
                    <Text4 htmlFor="programme"> Hide Status</Text4>   
                    ...
                    <button className='purplebtn' >Ok</button> 
                    </div>
                </FlexColumn1>
...
export default HideStudentList; 
