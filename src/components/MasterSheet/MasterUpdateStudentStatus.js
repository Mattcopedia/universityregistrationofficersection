...
const MasterUpdateStudentStatus = () => {
...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
        Student Status<br className="responsivemodal"></br> has been uploaded successfully{" "}
        </Paragraphw>
       ...
       <FlexColumnRoot>
      <Paragraph> Update Student<br className="responsivemodal"></br> Status</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot  src={`https://file.rendit.io/n/mFChwWBxwbuAYdHp0WHS.png`}  /> 
       </div>  
     
    </div> 

        <div className='mx-auto my-5'>
        <EditProfileRoot>Update Student Status</EditProfileRoot>
        </div>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
                ...
                <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                 ...
                 <Text4 htmlFor="OldPassword"> Choose option</Text4>   
...
export default MasterUpdateStudentStatus; 
