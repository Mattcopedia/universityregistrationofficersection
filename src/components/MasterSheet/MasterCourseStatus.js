...
{ shouldshow && (
      ...
      <FlexColumnw>
        ...
        <Paragraphw>
          Course Status<br className="responsivemodal"></br> has been updated successfully{" "}
        </Paragraphw>
       ...
       <FlexColumnRoot>
      <Paragraph> Course<br className="responsivemodal"></br> Status</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot  src={`https://file.rendit.io/n/g9KOdVTrXQycPHUxCNOG.svg`}  /> 
       </div>  
     
    </div> 

        <div className='mx-auto my-5'>
        <EditProfileRoot>Enter Course Status</EditProfileRoot>
        </div>
          ...
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>
             ...
             <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                    ...
                    <Text4 htmlFor="programme"> Select Programme</Text4>   
                    ...
                    <Text4 htmlFor="programme"> Course Code</Text4>   

                    <div className="amendment  pr-12 md:pr-0 lg:pr-0 ">
                    <select>
                    <option selected>CSC 300 </option> 
                ...
                <FlexColumn2 margin={`0px 0px 10px 0px`}> 
                 ...
                 <Text4 htmlFor="Enter Student Id"> Enter Class Year</Text4>   
                 <div className='pr-10 md:pr-12 lg:pr-0'>     
                 <input  style={{height: "44px"}} ref={focusDiv} className='form' placeholder='2010-2011'  type="text" id="StudentId"/>  
              </div>  
                    ...
                    <button className='purplebtn' >Update</button> 
                    </div>
                </FlexColumn1>
...
export default MasterCourseStatus; 
