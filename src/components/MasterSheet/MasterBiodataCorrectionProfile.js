...
import MasterSheetBiodataCorrections from './MasterSheetBiodataCorrection';

const MasterBiodataCorrrectionsProfile = () => {
...
export default MasterBiodataCorrrectionsProfile