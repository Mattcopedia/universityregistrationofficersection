...
const RetrospectiveRegistration = () => {
  const [shouldshow, setShouldshow] = useState(false);
    ...
    return  ( 
      ...
      <FlexColumns>
        ...
        <Paragraphs>
          Student Registration <br className="responsivemodal"></br>has been uploaded successfully{" "}
        </Paragraphs>
       ...
       <h1 className="text-left ml-3 text-indigo-900 font-black text-lg">Retrospective registration</h1>  
        <p className=" py-1 ml-3 not-italic font-normal text-sm text-gray-900">
                    Upload Course registration in csv format.only two fields are required
                       </p> 

        <p className="not-italic ml-3 font-bold text-md text-purple-900">Student ID and Course Code</p> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/AMlSDeIf6MI2wM9X3V5m.png`} /> 
       </div>  
            ...
            <FlexColumn>                       
                ...
                <select>
                 ...
                 <input className='file' id="uploadCSV" type="file"/>
                    ...
                    <button className='purplebtn' onClick={() => setShouldshow(true)}> Register</button> 
                    </div>
...
export default RetrospectiveRegistration; 
